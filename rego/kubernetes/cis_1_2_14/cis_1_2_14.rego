...
violation[msg]{
    ...
    args_contains_string(commandArgs,"--disable-admission-plugins","ServiceAccount")
    msg = sprintf("%v Ensure that the admission control plugin ServiceAccount is set (Automated)",[container.name])

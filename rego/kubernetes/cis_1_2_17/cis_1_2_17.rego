...
violation[msg]{
    ...
    not args_contains_string(commandArgs,"--enable-admission-plugins","NodeRestriction")
    msg = sprintf("%v Ensure that the admission control plugin NodeRestriction is set (Automated)",[container.name])

...
violation[msg]{
    ...
    msg = sprintf("cis_1_2_9 Ensure that the --authorization-mode argument includes RBAC (Automated)",[container.name])
...
argus_judement(commandArgs) = "allow"{
   ...
   not args_contains_string(commandArgs,"--authorization-mode","RBAC")
}else = "notallow"
